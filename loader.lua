...
local CONFIG = {
    BASE_URL    = "https://raw.githubusercontent.com/LostInSynntaxx/RideAPet/main/src/",
    VERSION_URL = "https://raw.githubusercontent.com/LostInSynntaxx/RideAPet/main/version.txt",
