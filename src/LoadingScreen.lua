...
function LoadingScreen.Show()
    ...
    -- ลบของเก่า
    local old = targetParent:FindFirstChild("LuxuryXHUB_Loading")
    if old then old:Destroy() end

    -- ═══ ScreenGui ═══
    screenGui = Instance.new("ScreenGui")
    screenGui.Name = "LuxuryXHUB_Loading"
...
function LoadingScreen.Complete()
    ...
    -- Fade out blur
    local blur = game:GetService("Lighting"):FindFirstChild("LuxuryXHUB_Blur")
    if blur then
