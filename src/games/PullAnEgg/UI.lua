...
local UI = {
    ScreenGui = nil,
    ToggleGui = nil, -- Fix: declare all fields upfront
    MainFrame = nil
}
...
function UI.build()
    ...
    local function createTab(name, icon)
        ...
        page.CanvasSize = UDim2.new(0, 0, 0, 0) -- Fix: required for AutomaticCanvasSize
        page.AutomaticCanvasSize = Enum.AutomaticCanvasSize.Y -- Fix: allows content to scroll
    ...
    local function createPanelSection(page, sectionTitle)
        ...
        outerPadding.PaddingBottom = UDim.new(0, 12) -- Fix: was UDim2, must be UDim
