...
local function buildUI()
    ...
    titleLbl.BackgroundTransparency=1 titleLbl.Text="LuxuryXHUB"
...
function Runtime.Unload()
    ...
    print("[LuxuryXHUB] ♻️  Pull An Egg unloaded successfully.")
end

getgenv().LuxuryXHUB_PullAnEgg = Runtime
print("[LuxuryXHUB] ✓ Pull An Egg Suite loaded. Press [LeftControl] or tap 🐾 to open.")
